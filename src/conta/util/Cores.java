...
public class Cores {
	...
	//Text Color Bold//cor forte do texto
	...
	//Reset Text Underline//cor de texto
	...
	// Text Color High Intensity//cor com claridade
	...
	// Text Color Bold High Intensity//mais clara
